...
<template>
    <NuxtLayout name="marketing-layout">
        <div class="pt-43.5 flex  justify-center items-center px-40 pb-20">
            <div class="h-167 w-299  p-2.5 flex justify-between font-sans relative shadow-[0_0_60px_30px_#00000008] rounded-lg">
                <!-- left -->
                <div
